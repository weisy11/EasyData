...
import pmp
from pmp.ops import *
from pmp.utils.helper import get_output_keys, gen_input_name
from pmp.core.workspace import create
...
class Executor(object):
    ...
    def __init__(self, env_cfg, model_cfg):
        ...
        for op in model_cfg:
            ...
            op_cfg = list(op.values())[0]
            op_name = op_cfg['name']
            self.op_name2op[op_name] = create(op_arch, env_cfg, op_cfg)
    ...
    def run(self, input, frame_id=-1, vis=False):
